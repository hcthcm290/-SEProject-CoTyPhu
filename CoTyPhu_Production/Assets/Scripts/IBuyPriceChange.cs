...
public interface IBuyPriceChange
{
	//  Properties ------------------------------------
	float buyPriceChange { get; set; }

	//  Methods ---------------------------------------
	float GetBuyPriceChange(float basePrice, float delta); //return về một tổng delta cũ và delta mới (delta là số tiền thay đổi)
