...
public interface ISellPriceChange
{
	//  Properties ------------------------------------
	float sellPriceChange { get; set; }

	//  Methods ---------------------------------------
	float GetSellPriceChange(float basePrice, float delta); //return về một tổng delta cũ và delta mới (delta là số tiền thay đổi)
