...
public interface IGoldReceiveChange
{
	//  Properties ------------------------------------
	float goldReceiveChange { get; set; }

	//  Methods ---------------------------------------
	float GetGoldReceiveChange(float basePrice, float delta); //return về một tổng delta cũ và delta mới (delta là số tiền thay đổi)
